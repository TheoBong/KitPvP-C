...
public final class Messages {
    ...
    public static final String BANNED_PERMANENTLY = CC.D_RED + "You have been permanently banned from Cheatin Network." + APPEAL_MESSAGE;
    public static final String BANNED_TEMPORARILY = CC.D_RED + "You are temporarily banned from Cheatin Network.\nThis ban will expire in %s." + APPEAL_MESSAGE;
