package com.bongbong.kitpvp.duels.impl;

import com.bongbong.kitpvp.KitPvPPlugin;
import com.bongbong.kitpvp.duels.*;
...
import com.bongbong.kitpvp.player.PreviousMatch;
import com.bongbong.kitpvp.player.Profile;
import com.bongbong.kitpvp.util.PlayerUtils;
...
public class Duel extends Occupation {
    ...
    public Duel(KitPvPPlugin plugin, String id) {
        super(plugin, id);
    }
    ...
    public void start() {
        ...
        plugin.getReplayAPI().recordReplay(getId(), plugin.getServer().getConsoleSender(), getAlivePlayers());
        for (Player player : getAlivePlayers()) {
            Profile profile = plugin.getPlayerManager().getProfile(player);
            profile.addDuel(getId());
        }
    ...
    public void end() {
        ...
        plugin.getReplayAPI().stopReplay(getId(), true);
